!function ($) {
    ...
    MorrisCharts.prototype.createLineChart = function (element, data, xkey, ykeys, labels, lineColors) {
        ...
        var $barData = [{y: '10 Sales', a: 75, b: 65}, {y: '9 Sales', a: 50, b: 40}, {
            y: '7 Sales',
            a: 75,
            b: 65
        }, {y: '9 Sales', a: 100, b: 90}, {y: '5 Sales', a: 90, b: 75}, {y: '7 Sales', a: 75, b: 65}, {
            y: '19 Sales',
            a: 80,
            b: 70
        }];
        this.createBarChart('morris-bar-example', $barData, 'y', ['a', 'b'], ['Series A', 'Series B'], ['#e22a6f', '#24d5d8']);
        var $stckedData = [{y: '8 Sales', a: 75, b: 65}, {y: '4 Sales', a: 50, b: 40}, {
            y: '3 Sales',
            a: 75,
            b: 65
        }, {y: '8 Sales', a: 100, b: 90}, {y: '9 Sales', a: 80, b: 65}, {y: '5 Sales', a: 70, b: 60}, {
            y: '6 Sales',
            a: 90,
            b: 80
        }];
